...
class Okx(Exchange):
    ...
    def parse_candles(api_json, api_fields, df_fields):
        ...
        df = df[df['confirm'] != 0] #Se elimina la vela en formación.
        df = df[df_fields]
    ...
    def set_params(pair, timeframe, api_batch):
        ...
        return {
            ...
            'bar': timeframe,
            'limit': api_batch
        } #OKX devuelve 300 velas como máximo o 100 si no se le indica "api_batch" (siempre que haya suficiente histórico).